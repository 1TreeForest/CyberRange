...
def slave(task_queue, group, grouped_item_dict, domain_list, item_dict, domain_list_len):
...
def master():
    ...
    for tag_len in [250]:  # 对多长的tag进行对比
    ...
    for i in range(NUMBER_OF_PROCESSES):
        p = Process(target=slave,
                    args=(task_queue, group, grouped_item_dict, domain_list, item_dict,
